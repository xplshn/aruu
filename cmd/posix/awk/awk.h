...
/* unsigned char is more trouble than its worth */
...
#define NN(p)                                                                                      \
  ((p) ? (p) : "(null)") /* guaranteed non-null for DPRINTF \
 */
#define DEBUG
#ifdef DEBUG
#define DPRINTF(...)                                                                               \
...
extern enum compile_states { RUNNING, COMPILING, ERROR_PRINTING } compile_time;
